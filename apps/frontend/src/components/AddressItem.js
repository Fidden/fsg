    ...
    <>
      <Disclosure>
        <Disclosure.Button className="w-full">
          <div className="outline-none text-left hover:bg-primary-2 max-sm:hover:bg-white flex items-center justify-between  pl-4 pr-3 max-sm:px-0 py-3 gap-3 rounded-xl">
            <div className="flex grow min-w-0 gap-3 items-center">
              <img className="w-8" src={`https://hatscripts.github.io/circle-flags/flags/${code}.svg`} alt={`Flag ${country.code}`} />
