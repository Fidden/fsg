        ...
        <div className="fixed inset-0 overflow-y-auto">
          <form onSubmit={handleSubmit} className="flex min-h-full items-center justify-center p-4 text-center">
            <Transition.Child
              ...
              <Dialog.Panel className="w-96  transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                ...
                {seconds !== -1 && (
                  <div className="mt-2 text-center">
                    <p className="text-md first-line:text-primary-60">{t('phoneForm.weSent', {phone, seconds})}</p>
                ...
                <div className="mt-8">
                  ...
                  {seconds === 0 && (
                    <button className="text-center text-md font-semibold w-full mt-8" onClick={resendCode}>
                  ...
                  <PrimaryButton className="w-full !bg-primary-4 !text-primary-100 mt-2" onClick={() => setVisible(false)} type="button">
                    {t('common:cancel')}
                  </PrimaryButton>
                </div>
              </Dialog.Panel>
