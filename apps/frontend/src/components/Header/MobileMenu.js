                                ...
                                <div className="fixed inset-0 px-4 overflow-y-auto">
                                    <div className="flex min-h-full py-20 bg-white justify-center">
                                        <Dialog.Panel className="w-96 z-50 max-w-full flex flex-col">
                                            <div
                                                className="flex fixed inset-0 px-4 bg-reverse_primary-85 backdrop-blur-md justify-between h-20 items-center">
                                                <div
                                                    className="svg_icon svg_24 justify-center h-10 flex items-center w-10"
                                                    onClick={closeModal}>
                                                    <Close/>
                                                </div>
                                            ...
                                            <MobileNavItem description="Презентация FSG"
                                                           img={<img width="24" height="24" src="/logo.png"
                                                                     alt="Logo"/>}>
                                                Главная
                                            </MobileNavItem>
                                            <Calculator>
                                                <MobileNavItem description="Расчёт стоимости доставки"
                                                               img={<CalculatorIcon/>}>
                                                    Калькулятор
                                                </MobileNavItem>
                                            </Calculator>
                                            ...
                                            <MobileNavItem description="Запрещённые предметы и не только"
                                                           img={<Alert/>}>
                                                Правила
                                            </MobileNavItem>
                                        </Dialog.Panel>
