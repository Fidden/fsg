                ...
                {({open}) => (
                    <>
                        <div className="relative mt-1">
                            <Listbox.Button
                                className="flex items-center h-10 px-2 rounded-xl text-md font-medium gap-x-2 text-primary-100 border-solid border-1 border-primary-8 hover:bg-primary-2 transition ease-in-out-out">
