          ...
          <form
            ...
            <div className="flex flex-col gap-4">
              <InputGroup label={t(`signUpPersonalDataForm.first_name_en`)} id="first_name_en" errors={errors.first_name_en}>
                <Input autoFocus required type="text" id="first_name_en" {...register('first_name_en')} placeholder="John" />
              </InputGroup>
              ...
              <InputGroup label={t(`signUpPersonalDataForm.document_number`)} id="document_number" errors={errors.document_number}>
                <Input required type="text" id="document_number" {...register('document_number')} placeholder="12AB63008" />
              </InputGroup>
