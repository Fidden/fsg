        ...
        <div className="flex gap-8 flex-col">
          <form
            ...
            <div className="flex flex-col gap-4">
              <InputGroup label={t(`signUpPersonalDataForm.company_name_en`)} id="company_name_en" errors={errors.company_name_en}>
                <Input autoFocus required type="text" id="company_name_en" {...register('company_name_en')} placeholder="Golden Apple LTD" />
              </InputGroup>
