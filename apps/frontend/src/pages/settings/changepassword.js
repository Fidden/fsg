        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            <InputGroup id="password" label="Текущий пароль">
              <Input required autoFocus maxLength="255" type={showCurrentPassword ? 'text' : 'password'} placeholder="********">
                <label
            ...
            <InputGroup id="password" label="Новый пароль">
              <Input required maxLength="255" type={showNewPassword ? 'text' : 'password'} placeholder="Придумайте новый пароль">
                <label
            ...
            <InputGroup id="password" label="Повторите новый пароль">
              <Input required maxLength="255" type={showRepeatPassword ? 'text' : 'password'} placeholder="Повторите придуманный пароль">
                <label
